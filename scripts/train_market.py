...
from bdh.market import MarketBDH, MarketBDHConfig, load_pretrained_weights
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Path to pre-trained model checkpoint (from train_pretrain.py). If provided, loads pre-trained weights for fine-tuning.'
    )
    parser.add_argument(
        '--freeze-core',
        action='store_true',
